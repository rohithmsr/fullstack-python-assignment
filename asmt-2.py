...
namesList = {
    ...
    'Cereals': ['Rice', 'Wheat'],
    'Dairy': ['Panneer', 'Ghee'],
    'Frozen Items': ['Frozen Paratha', 'Frozen Chicken']
}
...
class MyFrame(wx.Frame):
    ...
    def onNameCombo(self, event):
        ...
        self.priceText.SetLabel('Price : ' + str(row['price']))
    ...
    def __init__(self):
        super().__init__(parent = None, title = 'wxGroceries 🍞🌾🥛🍨')
        ...
        typesList = ['Bakery', 'Cereals', 'Dairy', 'Frozen Items']
